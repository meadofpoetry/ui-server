...
class tick_minor () =
  let o : tick_minor_js Js.t = Js.Unsafe.coerce @@ Js.Unsafe.obj [||] in
  object
...
(** The majorTick configuration defines options
    ...
    Omitted options are inherited from ticks configuration. *)
class tick_major () =
  let o : tick_major_js Js.t = Js.Unsafe.coerce @@ Js.Unsafe.obj [||] in
  object
    inherit base_option o ()
    inherit Font.t { size   = 12
                   ; color  = CSS.Color.rgb 102 102 102
...
class virtual tick_common () =
        object(self)
          ...
          val mutable virtual _obj : #tick_common_js Js.t
          inherit Font.t { size = 12
                         ; color = CSS.Color.rgb 102 102 102
                         ; family = "'Helvetica Neue','Helvetica','Arial',sans-serif"
                         ; style  = `Normal
