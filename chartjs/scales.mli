...
module Ticks : sig
  ...
  val minor : t -> Minor.t
  val set_minor : t -> Minor.t -> unit

  val major : t -> Major.t
  val set_major : t -> Major.t -> unit
...
module Time : sig
  ...
  module Time : sig
    ...
    val max : t -> time
    val set_max : t -> time -> unit

    (** If defined, this will override the data minimum *)
    val min : t -> time
    val set_min : t -> time -> unit
