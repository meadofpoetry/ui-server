...
module Org_freedesktop_PackageKit = struct
  ...
  let m_CanAuthorize =
    {
      ...
      Method.i_args = arg1 (Some "action_id", basic_string);
  ...
  let m_CreateTransaction =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "object_path", basic_object_path);
      Method.annotations = [ ("org.freedesktop.DBus.GLib.Async", "") ];
    }
  ...
  let m_GetDaemonState =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "state", basic_string);
      Method.annotations = [];
    }
  ...
  let m_GetPackageHistory =
    {
      ...
      Method.i_args =
        arg2 (Some "names", array basic_string) (Some "count", basic_uint32);
      Method.o_args =
        arg1 (Some "history", dict string (array (dict string variant)));
      Method.annotations =
  ...
  let m_GetTimeSinceAction =
    {
      ...
      Method.i_args = arg1 (Some "role", basic_uint32);
      Method.o_args = arg1 (Some "seconds", basic_uint32);
      Method.annotations = [];
    }
  ...
  let m_GetTransactionList =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "transactions", array basic_object_path);
      Method.annotations = [];
    }
  ...
  let m_StateHasChanged =
    {
      ...
      Method.i_args = arg1 (Some "reason", basic_string);
      Method.o_args = arg0;
      Method.annotations = [];
    }
  ...
  let s_TransactionListChanged =
    {
      ...
      Signal.args = arg1 (Some "transactions", array basic_string);
      Signal.annotations = [];
    }
  ...
  type 'a members = {
    ...
    m_GetPackageHistory :
      'a OBus_object.t ->
      string list * int32 ->
      (string * (string * OBus_value.V.single) list list) list Lwt.t;
...
module Org_freedesktop_PackageKit_Offline = struct
  ...
  let m_GetPrepared =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "package_ids", array basic_string);
      Method.annotations = [];
    }
  ...
  let m_Trigger =
    {
      ...
      Method.i_args = arg1 (Some "action", basic_string);
      Method.o_args = arg0;
      Method.annotations = [];
    }
