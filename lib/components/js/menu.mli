...
module Event : sig
  ...
  val selected : selected Js.t Dom_html.customEvent Js.t Dom_html.Event.typ
...
class t :
  ...
  -> object
       ...
       method private handle_selection_group :
         item:Dom_html.element Js.t -> Dom_html.element Js.t -> unit

       (** Returns the parent selection group of an element if one exists. *)
       method private get_selection_group :
         Dom_html.element Js.t -> Dom_html.element Js.t Js.opt
     end

val make_of_item_list :
     ?body:#Dom_html.element Js.t
  -> ?viewport:Menu_surface.viewport
  -> ?focus_on_open:bool
  -> ?fixed:bool
