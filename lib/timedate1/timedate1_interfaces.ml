...
module Org_freedesktop_timedate1 = struct
  ...
  let m_ListTimezones =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (None, array basic_string);
      Method.annotations = [];
    }
  ...
  let m_SetLocalRTC =
    {
      ...
      Method.i_args =
        arg3 (None, basic_boolean) (None, basic_boolean) (None, basic_boolean);
      Method.o_args = arg0;
      Method.annotations = [];
    }
  ...
  let m_SetNTP =
    {
      ...
      Method.i_args = arg2 (None, basic_boolean) (None, basic_boolean);
      Method.o_args = arg0;
      Method.annotations = [];
    }
  ...
  let m_SetTime =
    {
      ...
      Method.i_args =
        arg3 (None, basic_int64) (None, basic_boolean) (None, basic_boolean);
      Method.o_args = arg0;
      Method.annotations = [];
    }
