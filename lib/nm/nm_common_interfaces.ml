...
module Org_freedesktop_NetworkManager = struct
  ...
  let m_ActivateConnection =
    {
      ...
      Method.o_args = arg1 (Some "active_connection", basic_object_path);
      Method.annotations = [];
    }
  ...
  let m_CheckConnectivity =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "connectivity", basic_uint32);
      Method.annotations = [];
    }
  ...
  let m_CheckpointCreate =
    {
      ...
      Method.o_args = arg1 (Some "checkpoint", basic_object_path);
      Method.annotations = [];
    }
  ...
  let m_CheckpointDestroy =
    {
      ...
      Method.i_args = arg1 (Some "checkpoint", basic_object_path);
      Method.o_args = arg0;
      Method.annotations = [];
    }
  ...
  let m_CheckpointRollback =
    {
      ...
      Method.i_args = arg1 (Some "checkpoint", basic_object_path);
      Method.o_args = arg1 (Some "result", dict string basic_uint32);
      Method.annotations = [];
    }
  ...
  let m_DeactivateConnection =
    {
      ...
      Method.i_args = arg1 (Some "active_connection", basic_object_path);
      Method.o_args = arg0;
      Method.annotations = [];
    }
  ...
  let m_Enable =
    {
      ...
      Method.i_args = arg1 (Some "enable", basic_boolean);
      Method.o_args = arg0;
      Method.annotations = [];
    }
  ...
  let m_GetAllDevices =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "devices", array basic_object_path);
      Method.annotations =
        [ (OBus_introspect.csymbol, "impl_manager_get_all_devices") ];
    }
  ...
  let m_GetDeviceByIpIface =
    {
      ...
      Method.i_args = arg1 (Some "iface", basic_string);
      Method.o_args = arg1 (Some "device", basic_object_path);
      Method.annotations = [];
    }
  ...
  let m_GetLogging =
    {
      ...
      Method.i_args = arg0;
      Method.o_args =
        arg2 (Some "level", basic_string) (Some "domains", basic_string);
      Method.annotations = [];
    }
  ...
  let m_GetPermissions =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "permissions", dict string basic_string);
      Method.annotations = [];
    }
  ...
  let m_Sleep =
    {
      Method.interface;
      Method.member = "Sleep";
      Method.i_args = arg1 (Some "sleep", basic_boolean);
      Method.o_args = arg0;
      Method.annotations = [];
    }
  ...
  let m_state =
    {
      ...
      Method.member = "state";
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "state", basic_uint32);
      Method.annotations = [];
    }
  ...
  let s_DeviceAdded =
    {
      ...
      Signal.args = arg1 (Some "device_path", basic_object_path);
      Signal.annotations = [];
    }
  ...
  let s_StateChanged =
    {
      ...
      Signal.args = arg1 (Some "state", basic_uint32);
      Signal.annotations = [];
    }
  ...
  let make members =
    OBus_object.make_interface_unsafe interface []
      [|
        ...
        method_info m_AddAndActivateConnection
          members.m_AddAndActivateConnection;
      ...
      [|
        ...
        property_rw_info p_GlobalDnsConfiguration
          (fst members.p_GlobalDnsConfiguration)
          (snd members.p_GlobalDnsConfiguration);
        ...
        property_rw_info p_WimaxEnabled
          (fst members.p_WimaxEnabled)
          (snd members.p_WimaxEnabled);
        property_r_info p_WimaxHardwareEnabled members.p_WimaxHardwareEnabled;
        property_rw_info p_WirelessEnabled
          (fst members.p_WirelessEnabled)
          (snd members.p_WirelessEnabled);
        property_r_info p_WirelessHardwareEnabled
          members.p_WirelessHardwareEnabled;
        property_rw_info p_WwanEnabled
          (fst members.p_WwanEnabled)
          (snd members.p_WwanEnabled);
