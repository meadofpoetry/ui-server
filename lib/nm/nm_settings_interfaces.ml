...
module Org_freedesktop_NetworkManager_Settings_Connection = struct
  ...
  let m_GetSecrets =
    {
      ...
      Method.i_args = arg1 (Some "setting_name", basic_string);
      Method.o_args = arg1 (Some "secrets", dict string (dict string variant));
      Method.annotations = [];
    }
  ...
  let m_GetSettings =
    {
      ...
      Method.i_args = arg0;
      Method.o_args = arg1 (Some "settings", dict string (dict string variant));
      Method.annotations = [];
    }
  ...
  let m_Update =
    {
      ...
      Method.i_args = arg1 (Some "properties", dict string (dict string variant));
      Method.o_args = arg0;
      Method.annotations = [];
    }
