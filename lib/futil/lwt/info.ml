...
let is_dir (stat : t) = stat.st_kind = Lwt_unix.S_DIR

let is_reg_file (stat : t) = stat.st_kind = Lwt_unix.S_REG

let is_socket (stat : t) = stat.st_kind = Lwt_unix.S_SOCK
