...
let make_summary init pids rate id control =
...
let make_overview init pids rate id control =
...
let make (id : Stream.ID.t) control =
  ...
  let summary, summary_close =
    make_summary init pids rate id control in
  let overview, overview_close =
    make_overview init pids rate id control in
  let box =
