...
let get_measurements ~id control =
  Api_http.perform
    ~meth:`GET
    ~path:
      Path.Format.("api/board" @/ Int ^/ "receivers" @/ Int ^/ "measurements" @/ empty)
    ~query:Query.empty
    control
    id
...
let get_parameters ~id control =
  Api_http.perform
    ~meth:`GET
    ~path:Path.Format.("api/board" @/ Int ^/ "receivers" @/ Int ^/ "parameters" @/ empty)
    ~query:Query.empty
    control
    id
...
let get_plp_list ~id control =
  Api_http.perform
    ~meth:`GET
    ~path:Path.Format.("api/board" @/ Int ^/ "receivers" @/ Int ^/ "plp-list" @/ empty)
    ~query:Query.empty
    control
    id
