...
let parse_access access =
  ...
  | 2 ->
      "Redistribution over the Internet is enabled but only within a managed domain and \
       after a certain short period of time (e.g. 24 hours)."
  | 3 ->
      "Redistribution over the Internet is not allowed with the following exception: \
