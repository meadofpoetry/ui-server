  ...
  | {| dvb_rfu_1 : 2
    ...
    ->
      [
        ...
        Node.make ~offset:(off + off_2) 2 "DVB_reserved_future_use"
          (Bits (Int dvb_rfu_2));
        Node.make ~offset:(off + off_3) 22 "minimum_overall_smoothing_rate"
          (Dec (Uint min_rate));
        Node.make ~offset:(off + off_4) 2 "DVB_reserved_future_use"
          (Bits (Int dvb_rfu_3));
        Node.make ~offset:(off + off_5) 14 "maximum_overall_smoothing_rate"
          (Dec (Uint max_rate));
      ]
