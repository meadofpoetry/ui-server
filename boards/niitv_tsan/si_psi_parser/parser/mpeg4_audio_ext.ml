...
let parse bs off =
  ...
  | {| true          : 1
    ...
    ->
      ...
      let audio_profile =
        Bytes.parse ~offset:(off + off_3) audio_profile
      ...
      [
        ...
        Node.make ~offset:(off + off_2) 4 "num_of_loops"
          (Dec (Int num_of_loops));
        Node.make ~offset:(off + off_3) (num_of_loops * 8) ""
          (List audio_profile);
  ...
  | {| false         : 1
    ...
    ->
      ...
      [
        ...
        Node.make ~offset:(off + off_2) 4 "num_of_loops"
          (Dec (Int num_of_loops));
        Node.make ~offset:(off + off_3) (num_of_loops * 8) "audio_profile"
          (List audio_profile);
      ]
