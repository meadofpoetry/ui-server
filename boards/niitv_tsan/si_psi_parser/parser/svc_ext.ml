  ...
  | {| width             : 16
    ...
    ->
      [
        ...
        Node.make ~offset:(off + off_3) 16 "average_bitrate"
          (Dec (Int average_bitrate));
        Node.make ~offset:(off + off_4) 16 "maximum_bitrate"
          (Dec (Int maximum_bitrate));
        Node.make ~offset:(off + off_5) 3 "dependency_id"
          (Hex (Int dependency_id));
        Node.make ~offset:(off + off_6) 5 "reserved" (Bits (Int reserved_1));
        Node.make ~offset:(off + off_7) 4 "quality_id_start"
          (Hex (Int quality_id_start));
        Node.make ~offset:(off + off_8) 4 "quality_id_end"
          (Hex (Int quality_id_end));
        Node.make ~offset:(off + off_9) 3 "temporal_id_start"
          (Hex (Int temporal_id_start));
        Node.make ~offset:(off + off_10) 3 "temportal_id_end"
          (Hex (Int temporal_id_end));
        Node.make ~offset:(off + off_11) 1 "no_sei_nal_unit_present"
