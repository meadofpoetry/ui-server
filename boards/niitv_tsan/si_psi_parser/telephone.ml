...
let parse bs off =
  ...
  | {| rfu_1          : 2
    ...
    ; Node.make ~offset:(off + off_1) 1 "foreign_availability" (Bits (Bool foreign_avail))
    ...
    ; Node.make ~offset:(off + off_5) 3 "international_area_code_length" (Dec (Int length_2))
    ...
    ; Node.make ~offset:(off + off_8) 3 "national_area_code_length" (Dec (Int length_4))
    ; Node.make ~offset:(off + off_9) 4 "core_number_length" (Dec (Int length_5))
    ; Node.make ~offset:(off + off_10) (length_1 * 8) "country_prefix" (String country_prefix)
    ; Node.make ~offset:(off + off_11) (length_2 * 8) "international_area_code" (String int_code)
    ; Node.make ~offset:(off + off_12) (length_3 * 8) "operator_code" (String operator_code)
    ; Node.make ~offset:(off + off_13) (length_4 * 8) "national_area_code" (String nat_area_code)
    ; Node.make ~offset:(off + off_14) (length_5 * 8) "core_number" (String core_number)
    ]
