...
let parse bs off =
  ...
  | {| hrd_mng_valid_flag   : 1
     ...
     |} ->
    [ Node.make ~offset:off 1 "hrd_management_valid_flag" (Bits (Bool hrd_mng_valid_flag))
    ; Node.make ~offset:(off + off_1)  6  "reserved" (Bits (Int reserved_1))
    ; Node.make ~offset:(off + off_2)  1  "picture_and_timing_info_present" (Bits (Bool true))
    ...
    ; Node.make ~offset:(off + off_7)  32 "num_units_in_tick" (Bits (Int32 num_units_in_tick))
    ; Node.make ~offset:(off + off_8)  1  "fixed_frame_rate_flag" (Bits (Bool fixed_fr_rate_flag))
    ; Node.make ~offset:(off + off_9)  1  "temporal_poc_flag" (Bits (Bool temporal_poc_flag))
  ...
  | {| hrd_mng_valid_flag   : 1
    ...
    ; Node.make ~offset:(off + off_4)  7  "reserved" (Bits (Int reserved_2))
    ; Node.make ~offset:(off + off_5)  32 "num_units_in_tick" (Bits (Int32 num_units_in_tick))
    ; Node.make ~offset:(off + off_6)  1  "fixed_frame_rate_flag" (Bits (Bool fixed_fr_rate_flag))
    ; Node.make ~offset:(off + off_7)  1  "temporal_poc_flag" (Bits (Bool temporal_poc_flag))
  ...
  | {| hrd_mng_valid_flag   : 1
    ...
    [ Node.make ~offset:off 1 "hrd_management_valid_flag" (Bits (Bool hrd_mng_valid_flag))
    ; Node.make ~offset:(off + off_1)  6  "reserved" (Bits (Int reserved_1))
    ; Node.make ~offset:(off + off_2)  1  "picture_and_timing_info_present" (Bits (Bool false))
    ; Node.make ~offset:(off + off_3)  1  "fixed_frame_rate_flag" (Bits (Bool fixed_fr_rate_flag))
    ; Node.make ~offset:(off + off_4)  1  "temporal_poc_flag" (Bits (Bool temporal_poc_flag))
