...
type struct_api = { get_input : Common.Topology.topo_input -> (Structure.t list * string) Lwt.t
                  ; get_input_between : Common.Topology.topo_input -> string -> string -> (Structure.t list * string) list Lwt.t
                  }
