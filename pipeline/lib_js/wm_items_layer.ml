        ...
        (let ghost = new Dynamic_grid.Item.cell
         ...
         self#listen Widget.Event.dragover (fun _ e ->
             ...
             Option.iter (fun wh ->
                 ...
                 | None -> ()) t;
             true) |> ignore;
         self#listen Widget.Event.drop (fun _ e ->
